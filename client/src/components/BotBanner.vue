<template>
        ...
        <div class="p-6 bg-blue-50 border-l-4 border-blue-500 rounded-r-lg">
            ...
            <h3 class="text-blue-800 font-medium">Discover our telegram bot here!</h3>
            <button class="ml-auto">
                <svg class="text-blue-800" width="12" height="12" viewbox="0 0 12 12" fill="none" xmlns="http://www.w3.org/2000/svg">
