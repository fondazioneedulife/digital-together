<template>
    <div class="flex-col m-5 p-3" >
        <div class="grid grid-cols-3 gap-5 mt-10">
          <div v-for="(question, index) in questions" :key="index" class="max-w-2xl mx-4 sm:max-w-sm md:max-w-sm lg:max-w-sm xl:max-w-sm sm:mx-auto md:mx-auto lg:mx-auto xl:mx-auto mt-16 bg-white shadow-xl rounded-lg text-gray-900 ">
...
export default {
  data(){
    return{
      questions:['jbihfbeiw', 'hw f ef jer', 'hbfherbi', 'hewbfhiwebfewih']
    }
  }
}
</script>