    ...
    <div>
        ...
        <div class="container px-4 mx-auto">
            ...
            <ul>
                ...
                <button class="flex w-full text-left" @click="OpenDrop()">
                    ...
                    <div class="flex items-center justify-between">
                        ...
                        <span class="ml-4">
                        <svg v-if="isOpen == true" class="w-4 h-4" width="18" height="10" viewbox="0 0 18 10" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <div v-if='isOpen' class="mt-6 border-l-2 border-gray-50 pl-10">
                        <p class="mb-5 text-xl">The point of using Lorem Ipsum is that it has a more-or-less normal:</p>
                        <p class="mb-2 text-lg">
                        <span class="inline-block mr-6 h-2 w-2 rounded-full bg-red-500"></span>
